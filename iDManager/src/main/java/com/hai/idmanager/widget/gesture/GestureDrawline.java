package com.hai.idmanager.widget.gesture;
...
import com.hai.idmanager.widget.gesture.GesturePoint.POINT_STATE;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
		...
		paint.setStrokeWidth(DimensionUtil.dp2px(5));// 笔宽5dp
