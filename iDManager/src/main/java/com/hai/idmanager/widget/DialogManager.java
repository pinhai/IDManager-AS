...
import com.hai.idmanager.adapter.ListCheckAdapter;
...
//                attr.height = ScreenUtils.getScreenHeight(context)*1/4;
                attr.width = ScreenUtil.INSTANCE.getScreenWidth()*3/4;
    ...
    public void showMultiCheckListDialog(Context context, List<String> data, String chooseStr, final DialogListener.OnCheckListListener listListener, String title){
        showMultiCheckListDialog(context, data, chooseStr, listListener, ScreenUtil.INSTANCE.getScreenHeight()/2, title);
    }
